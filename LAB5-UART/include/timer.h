...
/** @brief Set overflow 4ms, prescaler 001 --> 1 */
#define TIM0_OVF_16US   TCCR0A &= ~((1<<CS02) | (1<<CS01)); TCCR0A |= (1<<CS00);/**nastaveni jednicky
/** @brief Set overflow 33ms, prescaler 010 --> 8 */
#define TIM0_OVF_128US  TCCR0A &= ~((1<<CS02) | (1<<CS01)); TCCR0A |= (1<<CS00);
/** @brief Set overflow 262ms, prescaler 011 --> 64 */
#define TIM0_OVF_1MS TCCR0A &= ~(1<<CS02)| (1<<CS00); TCCR0A |= (1<<CS01) ;
/** @brief Set overflow 1s, prescaler 100 --> 256 */
#define TIM0_OVF_41MS  TCCR0A &= ~(1<<CS01)|(1<<CS00) ; TCCR0A |= (1<<CS02);
/** @brief Set overflow 4s, prescaler // 101 --> 1024 */
#define TIM0_OVF_16MS  TCCR0A &= ~(1<<CS01); TCCR0A |= (1<<CS02) | (1<<CS10);
